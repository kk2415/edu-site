...
@DiscriminatorValue("DOUT")
@Entity
public class DispatchOutsiderEntity extends UserEntity {

    private String division;

    protected DispatchOutsiderEntity() {}

    private DispatchOutsiderEntity(
            String email,
            String name,
            String password,
            LocalDate birthday,
    ...
    public static DispatchOutsiderEntity of(
            String email,
            String name,
            String password,
            LocalDate birthday,
            ...
            String division)
    {
        return new DispatchOutsiderEntity(email, name, password, birthday, subEmail, phone, status, lastLoginAt, isExpired, role, division);
    }
}
